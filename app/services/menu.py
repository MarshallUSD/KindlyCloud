...
from app.models.menu import Menu, MenuItem, Meal, GroupMenu
...
class MenuService:
    ...
    def create_menu(self, current_user: User, menu_date: date,
                   items: List[dict], group_ids: Optional[List[str]] = None) -> Menu:
        ...
        if group_ids:
            for group_id in group_ids:
                ...
                if group and group.kindergarten_id == kinder.kindergarten_id:
    ...
    def get_menu_for_group_today(self, current_user: User, group_id: str) -> Optional[Menu]:
        """Get today's menu for a group."""
        from datetime import datetime
        today = datetime.now().date()
        return self.menu_repo.get_menu_for_group(group_id, today)
