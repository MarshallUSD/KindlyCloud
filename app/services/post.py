...
class PostService:
    ...
    def delete_post(self, current_user: User, post_id: str) -> bool:
        """Delete post (admin only)."""
        post = self.get_post(post_id)
        
        # Only original creator can delete
        if post.created_by_admin_user_id != current_user.user_id:
