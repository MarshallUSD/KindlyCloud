...
app.include_router(parent_submissions.router, prefix=f"{settings.API_V1_PREFIX}/parent-submissions", tags=["parent-submissions"])
app.include_router(parent_submissions.integration_router, prefix=f"{settings.API_V1_PREFIX}/integrations", tags=["integrations"])
